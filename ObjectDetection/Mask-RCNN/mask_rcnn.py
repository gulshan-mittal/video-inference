...
classesFile = "./ObjectDetection/Mask-RCNN/mscoco_labels.names"; 
classes = None
with open(classesFile, 'rt') as f:
   classes = f.read().rstrip('\n').split('\n')

# Give the textGraph and weight files for the model
textGraph = "./ObjectDetection/Mask-RCNN/mask_rcnn_inception_v2_coco_2018_01_28.pbtxt";   
modelWeights = "./ObjectDetection/Mask-RCNN/mask_rcnn_inception_v2_coco_2018_01_28/frozen_inference_graph.pb";
...
# Load the classes
colorsFile = "./ObjectDetection/Mask-RCNN/colors.txt";
...
if (args.image):
    ...
    outputFile = args.output + 'mask_rcnn_output.avi'
else:
    # Webcam input
...
while cv.waitKey(1) < 0:
    ...
    cap.set(cv.CAP_PROP_POS_MSEC,(count*80))
